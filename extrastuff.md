...
|                                        |                              | [Lyric:](http://www.zeneszoveg.hu/dalszoveg/41415/rajzfilm-slagerek/a-dzsungel-konyve---mint-te-olyan-leszek-zeneszoveg.html) te kölyök ne ~~ugratj~~ ugrass, rossz vicc! |                                      | bad joke you kid, don't pull my leg! |
...
| -nak,-nek  | [dative, possessor](https://magyartanulas.github.io/dative_possession/)| ennek  | annak  | Mi a neve ennek a madárnak magyarul? - (What is the name of this bird in Hungarian?)                     |
...
Note the [consonant assimilation](https://magyartanulas.github.io/extrastuff/#assimilation-of-ezaz) occurring with the last two. With `-val,-vel` the `v` assimilates and becomes `z`, and with `-ban,-ben`, the `z` becomes `b`.
